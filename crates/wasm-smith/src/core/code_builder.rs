...
instructions! {
    ...
    (None, f32_const, Float),
    (None, f64_const, Float),
    ...
    (Some(f32_f32_on_stack), f32_eq, Float),
    (Some(f32_f32_on_stack), f32_ne, Float),
    (Some(f32_f32_on_stack), f32_lt, Float),
    (Some(f32_f32_on_stack), f32_gt, Float),
    (Some(f32_f32_on_stack), f32_le, Float),
    (Some(f32_f32_on_stack), f32_ge, Float),
    (Some(f64_f64_on_stack), f64_eq, Float),
    (Some(f64_f64_on_stack), f64_ne, Float),
    (Some(f64_f64_on_stack), f64_lt, Float),
    (Some(f64_f64_on_stack), f64_gt, Float),
    (Some(f64_f64_on_stack), f64_le, Float),
    (Some(f64_f64_on_stack), f64_ge, Float),
    ...
    (Some(f32_on_stack), f32_abs, Float),
    (Some(f32_on_stack), f32_neg, Float),
    (Some(f32_on_stack), f32_ceil, Float),
    (Some(f32_on_stack), f32_floor, Float),
    (Some(f32_on_stack), f32_trunc, Float),
    (Some(f32_on_stack), f32_nearest, Float),
    (Some(f32_on_stack), f32_sqrt, Float),
    (Some(f32_f32_on_stack), f32_add, Float),
    (Some(f32_f32_on_stack), f32_sub, Float),
    (Some(f32_f32_on_stack), f32_mul, Float),
    (Some(f32_f32_on_stack), f32_div, Float),
    (Some(f32_f32_on_stack), f32_min, Float),
    (Some(f32_f32_on_stack), f32_max, Float),
    (Some(f32_f32_on_stack), f32_copysign, Float),
    (Some(f64_on_stack), f64_abs, Float),
    (Some(f64_on_stack), f64_neg, Float),
    (Some(f64_on_stack), f64_ceil, Float),
    (Some(f64_on_stack), f64_floor, Float),
    (Some(f64_on_stack), f64_trunc, Float),
    (Some(f64_on_stack), f64_nearest, Float),
    (Some(f64_on_stack), f64_sqrt, Float),
    (Some(f64_f64_on_stack), f64_add, Float),
    (Some(f64_f64_on_stack), f64_sub, Float),
    (Some(f64_f64_on_stack), f64_mul, Float),
    (Some(f64_f64_on_stack), f64_div, Float),
    (Some(f64_f64_on_stack), f64_min, Float),
    (Some(f64_f64_on_stack), f64_max, Float),
    (Some(f64_f64_on_stack), f64_copysign, Float),
    (Some(i64_on_stack), i32_wrap_i64, Numeric),
    (Some(f32_on_stack), i32_trunc_f32_s, Float),
    (Some(f32_on_stack), i32_trunc_f32_u, Float),
    (Some(f64_on_stack), i32_trunc_f64_s, Float),
    (Some(f64_on_stack), i32_trunc_f64_u, Float),
    (Some(i32_on_stack), i64_extend_i32_s, Numeric),
    (Some(i32_on_stack), i64_extend_i32_u, Numeric),
    (Some(f32_on_stack), i64_trunc_f32_s, Float),
    (Some(f32_on_stack), i64_trunc_f32_u, Float),
    (Some(f64_on_stack), i64_trunc_f64_s, Float),
    (Some(f64_on_stack), i64_trunc_f64_u, Float),
    (Some(i32_on_stack), f32_convert_i32_s, Float),
    (Some(i32_on_stack), f32_convert_i32_u, Float),
    (Some(i64_on_stack), f32_convert_i64_s, Float),
    (Some(i64_on_stack), f32_convert_i64_u, Float),
    (Some(f64_on_stack), f32_demote_f64, Float),
    (Some(i32_on_stack), f64_convert_i32_s, Float),
    (Some(i32_on_stack), f64_convert_i32_u, Float),
    (Some(i64_on_stack), f64_convert_i64_s, Float),
    (Some(i64_on_stack), f64_convert_i64_u, Float),
    (Some(f32_on_stack), f64_promote_f32, Float),
    (Some(f32_on_stack), i32_reinterpret_f32, Float),
    (Some(f64_on_stack), i64_reinterpret_f64, Float),
    (Some(i32_on_stack), f32_reinterpret_i32, Float),
    (Some(i64_on_stack), f64_reinterpret_i64, Float),
    ...
    (Some(nontrapping_f32_on_stack), i32_trunc_sat_f32_s, Float),
    (Some(nontrapping_f32_on_stack), i32_trunc_sat_f32_u, Float),
    (Some(nontrapping_f64_on_stack), i32_trunc_sat_f64_s, Float),
    (Some(nontrapping_f64_on_stack), i32_trunc_sat_f64_u, Float),
    (Some(nontrapping_f32_on_stack), i64_trunc_sat_f32_s, Float),
    (Some(nontrapping_f32_on_stack), i64_trunc_sat_f32_u, Float),
    (Some(nontrapping_f64_on_stack), i64_trunc_sat_f64_s, Float),
    (Some(nontrapping_f64_on_stack), i64_trunc_sat_f64_u, Float),
